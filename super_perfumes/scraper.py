"""
Super Perfumes Scraper - Complete Production Version
Scrapes https://www.sheeel.com/ar/super-perfumes.html with pagination
...
class SuperPerumesScraper:
    def __init__(self, s3_bucket=None, aws_access_key=None, aws_secret_key=None):
        self.base_url = "https://www.sheeel.com/ar/super-perfumes.html"
        self.category = "super_perfumes"
        self.products = []
    ...
    def scrape_all_pages(self):
        ...
        print("\n" + "="*70)
        print("🚀 SUPER PERFUMES SCRAPER - WITH PAGINATION")
        print("="*70)
        print(f"\nURL: {self.base_url}\n")
    ...
    def save_to_excel(self, include_s3_paths=False):
        ...
        filename = f"super_perfumes_{timestamp}.xlsx"
    ...
    def upload_results_to_s3(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"super_perfumes_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("🌸 SUPER PERFUMES SCRAPER - PRODUCTION")
        print("="*70)
