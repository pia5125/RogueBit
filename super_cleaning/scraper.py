"""
Super Cleaning Scraper - Complete Production Version
Scrapes https://www.sheeel.com/ar/super-cleaning1.html with pagination
...
class SuperCleaningScraper:
    def __init__(self, s3_bucket=None, aws_access_key=None, aws_secret_key=None):
        self.base_url = "https://www.sheeel.com/ar/super-cleaning1.html"
        self.category = "super_cleaning"
        self.products = []
    ...
    def scrape_all_pages(self):
        ...
        print("\n" + "="*70)
        print("🚀 SUPER CLEANING SCRAPER - WITH PAGINATION")
        print("="*70)
        print(f"\nURL: {self.base_url}\n")
    ...
    def save_to_excel(self, include_s3_paths=False):
        ...
        filename = f"super_cleaning_{timestamp}.xlsx"
    ...
    def upload_results_to_s3(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"super_cleaning_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("🧹 SUPER CLEANING SCRAPER - PRODUCTION")
        print("="*70)
