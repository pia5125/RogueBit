"""
Perfumes & Beauty Scraper - Optimized with Concurrent Subcategory Scraping
Scrapes https://www.sheeel.com/ar/perfumes-beauty.html and all subcategories
...
class PerfumesBeautyScraper:
    def __init__(self, s3_bucket=None, aws_access_key=None, aws_secret_key=None, max_concurrent_subcategories=3):
        self.base_url = "https://www.sheeel.com/ar/perfumes-beauty.html"
        self.category = "perfumes_beauty"
    ...
    async def get_subcategories(self, page):
        ...
        try:
            ...
            for elem in subcategory_elements:
                ...
                if url and name and '/ar/perfumes-beauty/' in url:
    ...
    async def scrape_all_subcategories(self):
        ...
        print("\n" + "="*70)
        print("� PERFUMES & BEAUTY SCRAPER - CONCURRENT SUBCATEGORIES")
        print("="*70)
    ...
    def save_to_excel(self, include_s3_paths=False):
        ...
        filename = f"perfumes_beauty_{timestamp}.xlsx"
    ...
    def upload_results_to_s3(self):
        ...
        # Upload to S3
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"perfumes_beauty_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("� PERFUMES & BEAUTY SCRAPER - OPTIMIZED (CONCURRENT)")
        print("="*70)
